 ...
 <!-- Heading -->
      <div class="card mb-4 wow fadeIn">
        ...
        <div class="card-body d-sm-flex justify-content-between">
         ...
         <form class="d-flex justify-content-center" action="OrderServlet?opt=queryById" method="post">
            <!-- Default input -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <!-- Table body -->
                <tbody>
                <c:forEach var="order" items="${allOrder }" varStatus="no">
                  <tr>
                    <td><c:out value="${order.id }"></c:out></td>
                    <td><c:out value="${order.userId }"></c:out></td>
                    <td><c:out value="${order.commodityId }"></c:out></td>
                    <td>
					<a href="OrderServlet?opt=delete&id=${order.id }">删除</a>
					<a href="OrderServlet?opt=update&id=${order.id }">修改</a>
					</td>
                  </tr>
                 </c:forEach>
                </tbody>
