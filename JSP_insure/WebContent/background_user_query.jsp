...
<body class="grey lighten-3">
 ...
 <!-- Heading -->
      <div class="card mb-4 wow fadeIn">
		...
		<a href="CommodityServlet?opt=add">新增用户</a>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <table class="table table-hover">
                ...
                <!-- Table body -->
                <tbody>
				<c:forEach var="user" items="${allUser }" varStatus="no">
                  <tr>
                    ...
                    <td>
					<a href="UserServlet?opt=delete&id=${user.id }">删除</a>
					<a href="UserServlet?opt=update&id=${user.id }">修改</a>
					</td>
                  </tr>
                  </c:forEach>
                </tbody>
